...
インターンシップマッチングサイト「キャリターン」利用約款（以下「本約款」といいます）は、株式会社AsianBridgeが提供するインターネット上のインターンシップマッチングサービス「キャリターン」の利用に関する事項を定めるものであり、当社にアカウント登録を申し込む企業及び登録された企業に適用されます。アカウントの登録を申し込まれた場合、本約款の内容全文を読んで理解しており、かつ本約款の全ての条項について承諾したものとみなします。

### 第1条　（定義）

1. 「キャリターン」（以下「本サービス」といいます）とは、株式会社AsianBridge（以
